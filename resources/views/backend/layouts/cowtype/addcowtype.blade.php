        ...
        <div class="container p-5">
          <form class="row g-3 d-flex justify-content-center p-5 bg-light shadow border" action="{{route('typeliststore')}}" method="post">
            ...
            <div class="col-md-6">
              ...
              <input required type="text" class="form-control" name="cow_type" id="cow_type" placeholder="Cow Type">
            </div>

            <div class="col-md-6">
              <label for="inputEmail4" class="form-label">Color</label>
              <input required type="text" class="form-control" name="color" id="color" placeholder="Color">
            </div>
