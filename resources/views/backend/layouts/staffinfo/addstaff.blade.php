        ...
        <div class="container p-5">
          <form class="row g-3 d-flex justify-content-center p-5 bg-light shadow border" action="{{route('addstaffstore')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              ...
              <input required type="text" class="form-control" name="staff_name" placeholder="Name">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input required type="tel" class="form-control" name="Mobile" placeholder="Mobile" id="inputEmail4">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input required type="text" class="form-control" id="inputEmail4" name="Salary" placeholder="Salary">
            </div>
            <div class="col-6">
              <label for="inputAddress" class="form-label">Address</label>
              <input required class="form-control" type="text" class="form-control" id="inputAddress" name="Address" placeholder="Address">
            </div>
