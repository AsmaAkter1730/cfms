        ...
        <div class="container p-5">
          <form class="row g-3 d-flex justify-content-center p-5 bg-light shadow border" action="{{route('addvaccinestore')}}" method="post">
            ...
            <div class="col-md-6">
              ...
              <input required type="date" class="form-control" id="inputEmail4" name="vaccine_date">
            </div>

            <div class="col-md-6">
              <label for="inputEmail4" class="form-label">Remarks</label>
              <input required type="text" class="form-control" name="Remarks" placeholder="Remarks">
            </div>
